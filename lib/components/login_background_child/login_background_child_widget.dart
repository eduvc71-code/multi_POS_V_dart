                    ...
                    children: [
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: FlutterFlowTheme.of(
                                context,
                              ).surface40.withValues(alpha: 0.8),
                              borderRadius: BorderRadius.circular(32),
                              border: Border.all(
                                color: FlutterFlowTheme.of(
                                  context,
                                ).alternate.withValues(alpha: 0.3),
                                width: 1,
                              ),
                            ),
                            child: Padding(
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Multi-POS v1.0.1 • Bolivia',
                            style: FlutterFlowTheme.of(context).labelSmall
                                .copyWith(color: Colors.white70, fontSize: 11, fontWeight: FontWeight.bold),
                          ),
                        ],
                      ),
                      const SizedBox(height: 16),
