      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        final confirm = await showDialog<bool>(
          ...
          builder: (ctx) => AlertDialog(
            title: const Text('Salir de Multi-POS'),
                ...
                child: ConstrainedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // BLOQUE 2: CUERPO (Contenido del Dashboard con scroll adaptativo sin overflow)
                      Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        formatBs(_model.todayTotalVentas),
                                        style: FlutterFlowTheme.of(context)
                                            .headlineSmall
                                            .copyWith(
                                              fontFamily: "Poppins",
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        onPressed: () => context.goNamed(
                                          InventarioDeProductosWidget.routeName,
                                        ),
                                      ),
                                    ],
                                  ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if (_model.ultimasVentas.isEmpty)
                                    ...
                                    Column(
                                      children: _model.ultimasVentas.map((
                                        venta,
                                      ) {
                                        final double tot =
                                            (venta['total'] as num?)
