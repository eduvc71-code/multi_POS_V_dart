...
class _ConfiguracionYEmpresasWidgetState
  ...
  Future<void> _loadEmpresaActiva() async {
    ...
    try {
      ...
      debugPrint('Error al cargar empresa desde Supabase: $e');
    }
  }
  ...
  Future<void> _showEmpleadosDialog() async {
    ...
    List<Map<String, dynamic>> usuarios = await SupabaseService.instance
        .readAllUsuarios(empresaId);
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: const InputDecoration(
                            ...
                            helperText:
                                'El colaborador la cambiará al iniciar sesión',
                            isDense: true,
                            border: OutlineInputBorder(),
                          ),
                        ),
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton<String>(
                              ...
                              items: const [
                                ...
                                DropdownMenuItem(
                                  value: 'Cajero',
                                  child: Text('Cajero (Solo Punto de Venta)'),
                                ),
                                DropdownMenuItem(
                                  value: 'Vendedor',
                                  child: Text(
                                    'Vendedor (Punto de Venta + Añadir Productos)',
                                  ),
                                ),
                              ],
                              onChanged: (val) {
                        ...
                        const SizedBox(height: 10),
                        const Text(
                          'Módulos y Permisos Autorizados:',
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 12,
                          ),
                        ...
                        CheckboxListTile(
                          ...
                          onChanged: (val) =>
                              setStateDialog(() => canVender = val ?? true),
                        ),
                        CheckboxListTile(
                          title: const Text(
                            'Adicionar Productos al Inventario (Escáner/Manual)',
                            style: TextStyle(fontSize: 11),
                          ),
                          subtitle: const Text(
                            'Permitido para Vendedor y Administrador',
                        ...
                        CheckboxListTile(
                          ...
                          subtitle: const Text(
                            'Restringido únicamente a Administrador/Dueño',
                            style: TextStyle(fontSize: 9, color: Colors.grey),
                          ),
                          ...
                          onChanged: (val) => setStateDialog(
                            () => canDeleteInventory = val ?? false,
                          ),
                        ),
                        CheckboxListTile(
                          title: const Text(
                            'Editar Precios o Modificar Stock Manualmente',
                            style: TextStyle(fontSize: 11),
                          ),
                          subtitle: const Text(
                            'Restringido únicamente a Administrador/Dueño',
                          ...
                          enabled: rol == 'Administrador',
                          onChanged: (val) =>
                              setStateDialog(() => canEditStock = val ?? false),
                        ),
                        CheckboxListTile(
                          title: const Text(
                ...
                if (isAddingNew || isEditing) ...[
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      final roleCode = rol == 'Administrador'
                          ? 'admin'
                          : (rol == 'Cajero' ? 'cajero' : 'vendedor');

                      final localDialogContext = dialogCtx;
                      try {
                        if (isEditing && editingUserId != null) {
                          await SupabaseService.instance.updateUsuario(
                            id: editingUserId!,
                            nombre: nombreVal,
                          ...
                          await SupabaseService.instance.createUsuario(
                            username: usernameVal,
                            password: passwordVal,
                        ...
                        if (!localDialogContext.mounted) return;
                                    ...
                                    child: Row(
                                      children: [
                                        FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            context.goNamed(
                                              PanelPrincipalWidget.routeName,
                                            );
                                          },
                                        ),
                                        const SizedBox(width: 8),
                                    ...
                                    children: [
                                      ...
                                      wrapWithModel(
                                        ...
                                        child: SettingsTileWidget(
                                          ...
                                          subtitle:
                                              'Gestionar colaboradores y roles',
                                          title: 'Colaboradores',
                        ...
                        child: Container(
                          child: wrapWithModel(
                            ...
                            child: BottomNavWidget(
                              child: () => const BottomNavChild5Widget(),
                            ),
                          ),
                        ),
                      ),
