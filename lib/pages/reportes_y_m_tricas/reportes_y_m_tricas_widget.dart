...
class _ReportesYMetricasWidgetState extends State<ReportesYMetricasWidget> {
  ...
  Future<void> _loadMetrics() async {
    ...
    try {
      final sales = await SupabaseService.instance.readAllVentas(empresaId);
      double sum = 0;
      int count = 0;
      ...
      debugPrint('Error al cargar reporte desde Supabase: $e');
    }
  }
                                        ...
                                        child: wrapWithModel(
                                          ...
                                          child: MetricCardWidget(
                                            ...
                                            tone: FlutterFlowTheme.of(context)
                                                .secondary,
                                            value: formatBs(_promedioTicket),
                                            isUp: true,
                                          ),
                                        ),
                                      ),
