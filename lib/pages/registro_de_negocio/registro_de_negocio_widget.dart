                              ...
                              onTap: () async {
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(currentContext).showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                        'Creando empresa y cuenta de usuario en Supabase...',
                                      ),
                                      duration: Duration(seconds: 4),
                                    ),
                                  );

                                  final empresaId = await SupabaseService
                                      .instance
                                      .registerFullBusiness(
                                        ...
                                        username: username,
                                        password: password,
                                        populateStandardInventory: false,
                                      );
                                  ...
                                  await prefs.setString(
                                    'user_name',
                                    ownerName.isEmpty ? username : ownerName,
                                  );
